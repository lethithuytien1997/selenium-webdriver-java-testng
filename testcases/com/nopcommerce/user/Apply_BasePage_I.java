...
public class Apply_BasePage_I {
	WebDriver driver;
	String email = "tien"+ RandomEmail() + "@gmail.com";;
	BasePage basePage;
	...
	public void TC_02_Register_Invalid_Email() {
		...
		basePage.senkeyToElement(driver, "//input[@id='FirstName']", "Tien");
		basePage.senkeyToElement(driver, "//input[@id='LastName']", "Le");
	...
	public void TC_03_Register_Success() {
		...
		basePage.senkeyToElement(driver, "//input[@id='FirstName']", "Tien");
		basePage.senkeyToElement(driver, "//input[@id='LastName']", "Le");
		basePage.senkeyToElement(driver, "//input[@id='Email']", email);
		basePage.senkeyToElement(driver, "//input[@id='Password']", "123456");
		basePage.senkeyToElement(driver, "//input[@id='ConfirmPassword']", "123456");
	...
	@Test
	public void TC_05_Register_Password_Less_Then_6_Chars() {
		basePage.waitForElementClickable(driver, "//a[@class='ico-register']");
		basePage.clickToElement(driver, "//a[@class='ico-register']");
	...
	public void TC_06_Register_Invalid_Confirm_Password() {
		...
		basePage.senkeyToElement(driver, "//input[@id='Email']", email);
		basePage.senkeyToElement(driver, "//input[@id='Password']", "123456");
		basePage.senkeyToElement(driver, "//input[@id='ConfirmPassword']", "653298");
